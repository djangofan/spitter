...
public class SpitterController {
	...
	public String editSpitter(@Valid EditSpitter editSpitter, BindingResult bindingResult,
	...
	public String followSpitter(Model model, @PathVariable String username, HttpSession session) {
	...
	public String unfollowSpitter(Model model, @PathVariable String username, HttpSession session) {
